...
Hobbies  : [
  ...
  Discord bot Development
          ...
          <pre className="text-xs font-mono m-0">
            <code>
              <span className="text-[#e3b341]">Name</span>     : <span className="text-[#e6edf3]">Zion</span>{"\n"}
              ...
              <span className="text-[#e3b341]">Discord</span>  : <span className="text-[#58a6ff]">855589141064318977</span>{"\n"}
